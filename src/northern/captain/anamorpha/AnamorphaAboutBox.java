...
public class AnamorphaAboutBox extends javax.swing.JDialog {

    public AnamorphaAboutBox(java.awt.Frame parent) {
        super(parent);
        initComponents();
    ...
    private void initComponents() {
        ...
        org.jdesktop.application.ResourceMap resourceMap = org.jdesktop.application.Application.getInstance(northern.captain.anamorpha.AnamorphaApp.class).getContext().getResourceMap(AnamorphaAboutBox.class);
        setTitle(resourceMap.getString("title")); // NOI18N
        setModal(true);
        setName("aboutBox"); // NOI18N
        setResizable(false);

        javax.swing.ActionMap actionMap = org.jdesktop.application.Application.getInstance(northern.captain.anamorpha.AnamorphaApp.class).getContext().getActionMap(AnamorphaAboutBox.class, this);
